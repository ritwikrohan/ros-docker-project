var app = new Vue({
    ...
    data: {
        ...
        waypoints: [
            { x: -0.1144245270958254, y: 0.3314882630474116 },
            { x: 0.5798450408826511, y: 0.3314882630474116 },
            { x: 0.5798450408826511, y: 0.077502796051131 },
        ...
        connect: function () {
            ...
            this.ros.on('connection', () => {
                ...
                this.mapGridClient.on('change', () => {
                    ...
                    // Calculate the shift to center the map
                    // const shiftX = (this.mapViewer.width / 2) - (this.mapGridClient.currentGrid.pose.position.x + mapWidth / 2);
                    // const shiftY = (this.mapViewer.height / 2) - (this.mapGridClient.currentGrid.pose.position.y + mapHeight / 2);

                    // Scale the map viewer
                    // this.mapViewer.scaleToDimensions(mapWidth, mapHeight);

                    // Shift the map to center
                    // this.mapViewer.shift(shiftX, shiftY);
                })
            })
